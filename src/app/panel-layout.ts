    ...
    this.ctx.container.innerHTML = `
      <div class="header">
        <div class="header-left">
          ...
          <span class="logo">SURFHUB.TV</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://linkedin.com/in/marcellodesales" target="_blank" rel="noopener" class="credit-link" title="LinkedIn">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M6.94 8.5H3.56V20h3.38V8.5zM5.25 3A1.97 1.97 0 003.28 5a1.97 1.97 0 103.94 0A1.97 1.97 0 005.25 3zM20.44 13.36c0-3.03-1.62-4.44-3.78-4.44-1.74 0-2.52.96-2.95 1.64V8.5h-3.38c.05 1.37 0 11.5 0 11.5h3.38v-6.42c0-.34.02-.68.12-.93.27-.68.89-1.39 1.93-1.39 1.36 0 1.91 1.04 1.91 2.57V20h3.38v-6.64z"/></svg>
            <span class="credit-text">@marcellodesales</span>
          </a>
          <a href="https://linkedin.com/in/marcellodesales" target="_blank" rel="noopener" class="github-link" title="LinkedIn">
